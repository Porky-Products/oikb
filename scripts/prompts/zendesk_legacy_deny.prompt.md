...
- Requester is a member of the credit department or accounts receivable
  (e.g. an @porky.com credit-department address) — supporting signal only;
  credit staff also file ordinary support tickets.
...
ticket: subject "Fwd: New account for 000000", requester from credit dept,
